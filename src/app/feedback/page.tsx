...
export default function FeedbackPage() {
  const { pastBoxes, profile } = getFeedbackSnapshot();
    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-10 px-4 py-12 sm:px-6 lg:px-8">
      <section className="max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-8 text-stone-600">
          Help CrateMatch learn your preferences. Rate each delivery 1–5 stars, tag what worked (or didn't), and leave optional notes.
